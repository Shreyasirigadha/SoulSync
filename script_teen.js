document.addEventListener("DOMContentLoaded", function () {
    ...
    calculateButton.addEventListener("click", function () {
        ...
        let contentt="Encourage open expression of feelings, build a support system, and stress the importance of a healthy lifestyle, including exercise, a balanced diet, and adequate sleep. Teach stress management techniques and time management skills. Limit screen time, foster positive social connections, and promote self-care. Encourage seeking professional help when needed. Be a positive role model, and maintain open communication. Lastly, emphasize gratitude and individualized support.Vandrevala Foundation Helpline: +919999 666 555 or 1860-2662-345 or 1800-2333-330 (24/7)";
